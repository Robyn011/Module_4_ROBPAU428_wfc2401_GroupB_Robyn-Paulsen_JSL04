...
var stock = (cansLeft >= 5) ? "We're stocked!" : "Time to restock!";
 console.log (stock);
...
let heartRate = 95; // Current heart rate in bpm
 var drink = (heartRate >= 100 ) ?  "Energy levels are high!" : "Boost needed!";
 console.log (drink);
...
let currentTemp = 4; // Current temperature in °C
 var chilled = (currentTemp <= 5)? "Chilled to perfection!": "Needs a cooler!";
console.log(chilled);
...
// If it's between 7am and midnight (24-hour format), print "Unleash the beast!"
// Otherwise, print "Better stick to water."
var drinkEnergyDrink = (currentHour > 7 & currentHour < 24) ?  "Unleash the beast!" : "Better stick to water.";
